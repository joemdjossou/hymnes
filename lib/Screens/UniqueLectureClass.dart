...
class _UniqueLectureClassState extends State<UniqueLectureClass> {
  ...
  AudioCache localTo = new AudioCache(
      // fixedPlayer: player,
      );
  String? mode;
  bool favoris =
      false; // = Provider.of<HymnesBrain>(context).getHymneFavoris(widget.numero);
  @override
  initState() {
    print('bhbgvgvg');
    super.initState();
  ...
  DropdownButtonHideUnderline modeur() {
    return DropdownButtonHideUnderline(
      child: DropdownButton<String>(
          ...
          value: voix,
          items: [
            DropdownMenuItem(child: Text('S'), value: 'soprano'),
            DropdownMenuItem(
              child: Text('A'),
              value: 'alto',
            ),
    ...
    return Consumer<HymnesBrain>(builder: (context, brain, child) {
      return (Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              icon: favoris ? Icon(Icons.bookmark) : Icon(Icons.book),
              onPressed: () {
                    ...
                    children: <Widget>[
                      Expanded(
                        child: TextButton(
                          ...
                          onPressed: () async {
                            // await localTo.play(
                            //     brain.getHymneAudio(widget.numero, voix) +
                            //         '.mp3');
                            //print('Playing : '+voix);
              ...
              onVerticalDragEnd: (DragEndDetails details) {
                showModalBottomSheet(
                    ...
                    builder: (context) => SingleChildScrollView(
                          ...
                          child: Text(
                              "Voici l'histoire de l'hymneVoici l'histoire de l'hymneVoici l'histoire de l'hymneVoici l'histoire de l'hymneVoici l'histoire de l'hymneVoici l'histoire de l'hymneVoici l'histoire de l'hymneVoici l'histoire de l'hymneVoici l'histoire de l'hymneVoici l'histoire de l'hymneVoici l'histoire de l'hymneVoici l'histoire de l'hymneVoici l'histoire de l'hymne"),
                        )));
                print(
                    'details de ${brain.getHymneFavoris(widget.numero!)} sont $details');
              },
            ),
          ),
        ),
